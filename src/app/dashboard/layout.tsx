...
export default function DashboardLayout({
  ...
  // Helper to highlight active navigation tabs
        ...
        <header className="bg-white border-b border-[#6B85A0]/10 sticky top-0 z-40 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-8">
              <Link href="/dashboard" className="text-xl font-bold font-display text-[#2A2F2D] tracking-tight flex items-center space-x-2">
